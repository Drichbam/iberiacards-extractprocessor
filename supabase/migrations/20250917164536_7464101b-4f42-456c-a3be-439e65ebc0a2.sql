...
-- Drop the foreign key constraint from shops to categories first
ALTER TABLE public.shops DROP CONSTRAINT IF EXISTS shops_category_id_fkey;
...
-- Migrate existing categories to subcategories with proper parent assignments
DO $$
DECLARE
